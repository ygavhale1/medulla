...
function checkEmail()
 {
	...
	{
		window.alert("Plase Enter Valid E-Mail Address");
		document.getElementById('email').value="";;
		document.getElementById('email').focus();
		return false;
	}
...
function phonel()
{
	...
	function checkempty()
	{
		...
		if(document.getElementById('enq').value=="Careers")
		{
			...
			{
				alert("Please Enter the Compensation.");
...
<div>
<div class="body_content_wrap"><form name="contact" action="" method="get">
...
<div class="flield_box_bkr2">
  <label>
  <select name="enq" id="enq" class="flield_list_menu" onchange="changeOpt();" >
    <option value="Our Services">Our Services</option>
    <option value="Careers" >Careers</option>
    <option value="General" >General</option>
    <option selected="selected" value="1">Select Your Topic</option>
  </select>
  </label>
</div>
</div>
...
<div class="flield_box_bkr2">
  <label>
  <select name="country" class="flield_list_menu" id="country">
...
<div class="selection_drop" id="func" >
  <div class="flield_text"></div>
<div class="flield_box_bkr">
  <label></label>
</div>
<div class="flield_text"></div>
